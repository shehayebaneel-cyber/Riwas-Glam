...
export interface Service { id: number; categoryId: number; name: string; description: string; durationMin: number; price: number; isActive: boolean; sortOrder: number; staff?: StaffLite[] }
export interface AddOn { id: number; categoryId: number; name: string; price: number; durationMin: number; isActive: boolean; sortOrder: number }
export interface Category { id: number; name: string; emoji: string; isActive: boolean; sortOrder: number; services: Service[]; addOns: AddOn[] }
export interface Staff { id: number; name: string; role: string; bio?: string; avatar: string | null }
