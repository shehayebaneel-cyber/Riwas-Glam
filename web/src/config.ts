...
export const SITE = {
  ...
  about:
    "At Riwa's Glam we believe every visit should feel like a treat. Our team of specialists blends skill, quality products and a warm atmosphere to help you leave glowing — whether it's flawless makeup, stunning lashes, perfect nails or a special-occasion glam.",
  why: [
  ...
  galleryItems: [
    ...
    { src: "https://images.unsplash.com/photo-1521590832167-7bcbfaa6381f?w=700&q=80&auto=format&fit=crop", cat: "Hair" },
